...
- **Track Matte Inversion & Non-Adjacent Routing:** [`Shape.kt`](file:///usr/local/google/home/myavorskyi/AndroidStudioProjects/my-horologist-lottie-grandchild-fix-v2/remotecompose/lottie/src/main/java/com/google/android/horologist/remotecompose/lottie/renderer/Shape.kt) must compute inverted alpha clipping (`tt: 2`), resolve `matteParent` pointers across non-adjacent layer indices, and preserve hidden matte sources (`hd: true`).
