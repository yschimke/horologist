...
- [x] [Phase 2: Core Rendering & Mathematical Parity](#PL_LOTTIE_SPEC_PARITY_P2)
  - [x] [Task 2.1: Spatial Bézier Tangents (to, ti) in Position Keyframes](#PL_LOTTIE_SPEC_PARITY_T2_1)
  - [x] [Task 2.2: Gradient Shaders for GradientFill and GradientStroke](#PL_LOTTIE_SPEC_PARITY_T2_2)
  - [x] [Task 2.3: Stroke Dash Pattern (d) and Miter Limit (ml)](#PL_LOTTIE_SPEC_PARITY_T2_3)
  - [x] [Task 2.4: Path FillRule (EvenOdd) & Primitive TrimPath Dispatch](#PL_LOTTIE_SPEC_PARITY_T2_4)
  - [x] [Task 2.5: Local Layer Timing Scaling & Inverted Alpha Track Mattes](#PL_LOTTIE_SPEC_PARITY_T2_5)
- [x] [Phase 3: Composition, Precomps & Layer Mask Pipeline](#PL_LOTTIE_SPEC_PARITY_P3)
  - [x] [Task 3.1: Root assets[] Asset Registry Model](#PL_LOTTIE_SPEC_PARITY_T3_1)
  - [x] [Task 3.2: PrecompLayer Recursive Sub-Composition Rendering Engine](#PL_LOTTIE_SPEC_PARITY_T3_2)
  - [x] [Task 3.3: Layer Masks Pipeline (masksProperties)](#PL_LOTTIE_SPEC_PARITY_T3_3)
