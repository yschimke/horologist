...
class StrokeMiterRegressionTest : FixtureParityHarness() {
  @Test fun solidLowMiterBevelsCorners() = verify(false, 0)

  @Test fun solidHighMiterRetainsCorners() = verify(false, 4)

  @Test fun gradientLowMiterBevelsCorners() = verify(true, 0)

  @Test fun gradientHighMiterRetainsCorners() = verify(true, 4)

  @Test fun solidAnimatedMiterUpdatesExistingDocument() = verifyMotion(false)

  @Test fun gradientAnimatedMiterUpdatesExistingDocument() = verifyMotion(true)
