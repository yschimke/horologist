...
class BundledFixtureParityTest : FixtureParityHarness() {
  ...
  @Test fun geometry() = sample(R.raw.geometry)

  @Test fun playPause() = sample(R.raw.play_pause)

  @Test fun next() = sample(R.raw.next)

  @Test fun m3PlayPause() = sample(R.raw.m3_play_pause)

  @Test fun m3Next() = sample(R.raw.m3_next)

  @Test fun volumeUp() = sample(R.raw.volume_up)

  @Test fun volumeDown() = sample(R.raw.volume_down)

  @Test fun muteToUnmute() = sample(R.raw.mute_to_unmute)

  @Test fun unmuteToMute() = sample(R.raw.unmute_to_mute)
