...
Importable sticker-sheet for **`horologist`**, rendered from the committed
`@Preview` catalog in [`yschimke/horologist`](https://github.com/yschimke/horologist). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/horologist/blob/design-artifacts/horologist/index.html)**
...
| --- | --- |
| Components | **80** |
| Rendered images (PNG) | **80** |
| Editable wireframes (SVG) | **80** |
| Editable design vectors (figma-svg) | **80** |
| Components with a11y greenlines | **44** |
| Library | — |
| Renderer | compose-preview 1.1.0 |
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/horologist/actions/workflows/design-artifacts.yml)
