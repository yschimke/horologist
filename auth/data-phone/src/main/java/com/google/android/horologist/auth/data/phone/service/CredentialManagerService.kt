...
package com.google.android.horologist.auth.data.phone.service
...
open class CredentialManagerService : BaseGrpcDataService<CredentialManagerServiceCoroutineImplBase>() {
    ...
    override fun buildService(): CredentialManagerServiceCoroutineImplBase {
        return CredentialManagerImpl(credentialManager)
    }
}